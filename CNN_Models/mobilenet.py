...
Original file is located at
    https://colab.research.google.com/drive/1l75Y5I0bW4sB-JsNiPgJTLNalTaOwvw4
"""
...
import keras
mobilenet = MobileNet(include_top=False, weights='imagenet', input_shape=(256,256,3))
...
pathv = '/content/drive/MyDrive/Graph_CNN_Dataset/VG_Dataset'
...
hist = model.fit(x_rest, y_rest, batch_size = 15, validation_data=(x_sub, y_sub), shuffle = True, epochs=10, verbose=1)
